...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * A contrsuctor that takes in two parameters, both of which are strings
     * This contructor changes this.name to be the concatenation of both parameters
     *
    ...
    public int compareTo(Silly other) {
        ...
        int output = this.toString().length() - other.toString().length();
